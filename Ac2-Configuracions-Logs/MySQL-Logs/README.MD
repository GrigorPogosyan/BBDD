...
6. Ara si reiniciem el servei de mysqld totes les configuracions de sessió no estarán ja actives, i es carregaria les configuracions de nivell de fitxer.
