...
```
I a les taules actor, address i category, afegirem el tablespace `ts1` creat anteriorment, de manera que es veurien així finalment les taules amb el paràmetre `TABLESPACE`:
<details open>
